...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        if(!has_set_take_off_point){ 
            ...
            /* motion::new_point target_point_srv;
            target_point_srv.request.requested_new_point = true;

            if (target_point_client.call(target_point_srv)){

                target_point_global = target_point_srv.response.response_new_point;
